        ...
        visits: [
            {
                ...
                present_illness: "low mood,low, energy,, anhedonia, ,over thincking,, disturbed sleep,, disturbed appetite,",
                suicide: "",
                family_hx: "",
            ...
            data: {
                ...
                demographics: {
                    create: {
                        ...
                        residence: element.residence === "baghdad" ? "بغداد" : element.residence,
...
const func = () => {
    fetch("https://psychiatry.azurewebsites.net/find/6507f518ff9709dd1c0fc42d", {
        ...
        .then(function (data) {
        fs_1.default.writeFile("results.json", JSON.stringify(data, null, 2), (err) => {
            if (err) {
...
// func();
const migrateTo = () => {
    const readData = fs_1.default.readFileSync("results4.json", "utf8");
    arrayOfPatients = JSON.parse(readData);
    arrayOfPatients.forEach(async (element) => {
